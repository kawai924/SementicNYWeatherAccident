...
valid_vehicle_types = ['3-Door', 'Ambulance', 'Bike', 'BoxTruck', 'Bus', 'ChassisCab', 'ConcreteMixer', 'E-bike',
                       'E-scooter', 'Moped', 'Motorbike', 'Pickup-Truck', 'Sedan', 'StationWagon', 'Taxi',
                       'TractorTruckDiesel', 'TractorTruckGasoline', 'Van', 'VanTruck']

def isValidVehicle(vehicleData):
    return valid_vehicle_types.__contains__(vehicleData)
